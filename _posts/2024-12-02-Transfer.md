...
## References
1.  Feasibility of Using Wearable EMG Armbands combined with Unsupervised Transfer Learning for Seamless Myoelectric Control

2.  Explainable deep learning for sEMG-based similar gesture recognition: A Shapley-value-based solution
