...
The drawing canvas is a separate image that serves as a layer for storing the user's drawings. It is created using NumPy's np.zeros() function with dimensions (720, 1280, 3). This creates a blank black image with a resolution of 720x1280 pixels and 3 color channels (BGR). 
