...
hidden: false
---
Programmed a nRF52833 microcontroller in C to control a differnetial drive car and autonomously operate a gripper on detection of objects using an IR sensor
